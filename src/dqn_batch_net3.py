...
class DQNAgent:
    def __init__(self, state_size, action_size, filename):
        ...
        self.learning_rate = 0.0015  # 0.001
    ...
    def _build_model(self):
        ...
        k0 = Input(tensor=K.variable([-1.]))
        k1 = Input(tensor=K.variable([0.]))
        k2 = Input(tensor=K.variable([1.]))
...
if __name__ == "__main__":    
    ...
    batch_size = 32
    try:
        agent.load(str(parenpath + '/ckpt/' + 'ckpt.h5'))
        print('\n\n\n previous model loaded successfully!!!\n\n\n')
    except:
        print('\n\n\n no previous model loaded...\n\n\n')
